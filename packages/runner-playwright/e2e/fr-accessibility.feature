...
Fonctionnalité: Accessibility Step Definition
  ...
  Règle: a11y
    Scénario: key.Alors.a11y.check.default
    ...
    Scénario: key.Alors.a11y.check.withAllowFailure
    ...
    Scénario: key.Alors.a11y.check.onlyCritical
      Lorsque je visite l'Url "https://e2e-test-quest.github.io/weather-app/"
      Et je vais à l'intérieur de bouton nommée "Get started"
      Et je clique
      Et je reinitialise le contexte
    ...
    Scénario: key.Alors.a11y.check.withFixtureOption
      Lorsque je visite l'Url "https://e2e-test-quest.github.io/weather-app/"
      Et je vais à l'intérieur de bouton nommée "Get started"
      Et je clique
      Et je reinitialise le contexte
    ...
    Scénario: key.Alors.a11y.check.withImpacts
      Lorsque je visite l'Url "https://e2e-test-quest.github.io/weather-app/"
      Et je vais à l'intérieur de bouton nommée "Get started"
      Et je clique
      Et je reinitialise le contexte
    ...
    Scénario: key.Alors.a11y.check.withFixtureContextEtFixtureOption
      Lorsque je visite l'Url "https://e2e-test-quest.github.io/weather-app/"
      Et je vais à l'intérieur de bouton nommée "Get started"
      Et je clique
      Et je reinitialise le contexte
    ...
    Scénario: key.Alors.a11y.check.withAllowFailureEtFixtureContextEtFixtureOption
      Lorsque je visite l'Url "https://e2e-test-quest.github.io/weather-app/"
      Et je vais à l'intérieur de bouton nommée "Get started"
      Et je clique
      Et je reinitialise le contexte
    ...
    Scénario: key.Alors.a11y.check.withTags
      Lorsque je visite l'Url "https://e2e-test-quest.github.io/weather-app/"
      Et je vais à l'intérieur de bouton nommée "Get started"
      Et je clique
      Et je reinitialise le contexte
  ...
  Règle: touches d'accessibilité
    Scénario: key.Alors.keyboard.press - Reverse Tab & Tab
      Lorsque je visite l'Url "https://e2e-test-quest.github.io/weather-app/"
      Et je vais à l'intérieur de bouton nommée "Get started"
    ...
    Scénario: key.Alors.keyboard.multiplePress - Reverse Tab & Tab
      Lorsque je visite l'Url "https://e2e-test-quest.github.io/weather-app/"
    ...
    Scénario: key.Alors.keyboard.press - Left right
      Lorsque je visite l'Url "https://e2e-test-quest.github.io/weather-app/"
      Et je vais à l'intérieur de bouton nommée "Get started"
      Et je clique
      Et je reinitialise le contexte
    ...
    Scénario: key.Alors.keyboard.press - Up Down
      Lorsque je visite l'Url "https://e2e-test-quest.github.io/weather-app/"
      Et je vais à l'intérieur de bouton nommée "Get started"
      Et je clique
      Et je reinitialise le contexte
