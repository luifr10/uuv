...
function translateFeatures(tempDir: string, configDir: string) {
    ...
    filenames.forEach(file => {
        ...
        let data = fs.readFileSync(
            ...
            { encoding: "utf8" });
        data = data
         .replaceAll("/\bSoit\b/g", "Given")
         .replaceAll("/\bSachant que\b/g", "Given")
         .replaceAll("/\bSachant qu'\b/g", "Given")
         .replaceAll("/\bSachant\b/g", "Given")
         .replaceAll("/\b[EÉ]tant donné que\b/g", "Given")
         .replaceAll("/\b[EÉ]tant donné que\b/g", "Given")
         .replaceAll("/\b[EÉ]tant donné qu'\b/g", "Given")
         .replaceAll("/\b[EÉ]tant données\b/g", "Given")
         .replaceAll("/\b[EÉ]tant donnés\b/g", "Given")
         .replaceAll("/\b[EÉ]tant donnée\b/g", "Given")
         .replaceAll("/\b[EÉ]tant donné\b/g", "Given")
         .replaceAll("/\bQuand\b/g", "When")
         .replaceAll("/\bLorsque\b/g", "When")
         .replaceAll("/\bLorsqu'\b/g", "When")
         .replaceAll("/\bAlors\b/g", "Then")
         .replaceAll("/\bDonc\b/g", "Then")
         .replaceAll("/\bEt que\b/g", "And")
         .replaceAll("/\bEt qu'\b/g", "And")
         .replaceAll("/\bEt\b/g", "And")
         .replaceAll("/\bMais que\b/g", "But")
         .replaceAll("/\bMais qu'\b/g", "But")
         .replaceAll("/\bMais\b/g", "But");
        data = "/*******************************\n" +
